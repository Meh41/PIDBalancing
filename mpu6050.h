...
#define MPU6050_ADDRESS_AD0_LOW     0x68 // address pin low (GND), default for many evaluation board
 ...
 *
 * @param sleep - 0 to sleep or >0 to wake up
 * @return 0 if no error or negative number if error occure
 */
 ...
 * @param length - Length of data bytes to be writen
 * @return 0 if no error or negative number if error occure
 */
 ...
 * @param length - Length of data bytes to be read
 * @return 0 if no error or negative number if error occure
 */
 ...
 * @param bit - Bit position in register
 * @param data - 0 for set bit to 0 or >0 to set bit to 1
 * @return 0 if no error or negative number if error occure
 */
